...
class MainActivity_admin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            navMenu = findViewById(R.id.navMenu_admin)
            ...
            when (item.itemId) {
                R.id.menu_principal -> {
                    ...
                    supportFragmentManager.commit {
                        replace<menu_principal_fragment>(R.id.fragment_conteiner_admin)
                ...
                R.id.pagos -> {
                    ...
                    supportFragmentManager.commit {
                        replace<pagos_fragment>(R.id.fragment_conteiner_admin)
                        setReorderingAllowed(true)
                        addToBackStack("replacement")
                    }
                    return@OnNavigationItemSelectedListener true
                ...
                R.id.item_desplegable -> {
                    ...
                    showOpcionesDesplegable(this@MainActivity_admin)
                    return@OnNavigationItemSelectedListener true
                }
    ...
    private fun showOpcionesDesplegable(context: Context) {
        try {
            ...
            val popupMenu = PopupMenu(ContextThemeWrapper(context, R.style.CustomPopupMenu_admin), findViewById(R.id.navMenu_admin))
                ...
                try {
                    when (menuItem.itemId) {
                        ...
                        R.id.creditos -> {
                            // Reemplazar el fragmento con el menú principal
                            supportFragmentManager.commit {
                                replace<fragment_creditos>(R.id.fragment_conteiner_admin)
                                setReorderingAllowed(true)
                                addToBackStack("replacement")
                            }
                        }
